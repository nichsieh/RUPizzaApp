...
public class ChicagoPizzaActivity extends AppCompatActivity {
    private ImageView ChicagoPizzaImageChanging;
    ...
    private final ChicagoPizza chicagoPizza = new ChicagoPizza();
    private Pizza pizza;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent button = new Intent(ChicagoPizzaActivity.this,
                        MainActivity.class);
        ...
        pizza_type_spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(ChicagoPizzaActivity.this, "Type selected: " + pizzaType, Toast.LENGTH_SHORT).show();
                // get crust type according to pizza type
                pizzaCrust = Crust.getCrust(pizzaType, "Chicago");
                // setting the images
                if (pizzaType.equalsIgnoreCase("Deluxe")) {
                    ChicagoPizzaImageChanging.setImageResource(R.drawable.chicago_deluxe);
                } else if (pizzaType.equalsIgnoreCase("Meatzza")) {
                    ChicagoPizzaImageChanging.setImageResource(R.drawable.chicago_meatzza);
                } else if (pizzaType.equalsIgnoreCase("BBQ Chicken")) {
                    ChicagoPizzaImageChanging.setImageResource(R.drawable.chicago_bbq_chicken);
                } else {
                    ChicagoPizzaImageChanging.setImageResource(R.drawable.chicago);
                }
        ...
        radioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                Toast.makeText(ChicagoPizzaActivity.this, "Size selected: " + pizzaSize.toString(), Toast.LENGTH_SHORT).show();
            }
        });
...
//                    AlertDialog confirmation = alert.create();
                ...
                Toast.makeText(ChicagoPizzaActivity.this, error, Toast.LENGTH_LONG).show();
            }
    ...
    private void initWidgets(){
        ...
        // image view
        ChicagoPizzaImageChanging = findViewById(R.id.ChicagoPizzaImageChanging);
        // toppings
